...
public class account {
	...
	private void input() {
		...
		id = question6_7_8.inputPositiveInt("Please input a number as int, please input again.");

		System.out.println("Nhập email: ");
		email = question6_7_8.inputString();

		System.out.println("Nhập username: ");
		username = question6_7_8.inputString();

		System.out.println("Nhập fullname: ");
		fullname = question6_7_8.inputString();
...
//	Khi người dùng nhập vào tuổi <= 0 thì throw ra Exception  InvalidAgeInputingException với message là: "The age must be greater than 0"
	private static int inputAge() throws InvalidAgeInputingException {
		int age = question6_7_8.inputPositiveInt("Please input an age as int, please input again.");
...
//	Và khi người dùng nhập vào tuổi < 18 thì in ra text "Your age must be greater than 18" và yêu cầu người dùng nhập lại tuổi
	...
	private static int inputAccountAge() {
		while (true) {
			try {
				int age = inputAge();
				if (age < 18) {
